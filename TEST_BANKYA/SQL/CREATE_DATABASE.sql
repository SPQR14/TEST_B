...
ALTER TABLE PRESTAMOS ADD CONSTRAINT PK_CLIENTE_P PRIMARY KEY (CONTRACTID);

ALTER TABLE PAGOS ADD CONSTRAINT FK_PRESTAMOS FOREIGN KEY (CONTRACTID) REFERENCES PRESTAMOS(CONTRACTID) ON UPDATE CASCADE ON DELETE CASCADE;
